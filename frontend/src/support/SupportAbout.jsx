...
export default function SupportAbout() {
  const { user } = useAuthStore();
    ...
    <div className="container mx-auto px-4 py-8">
                <h1 className="text-2xl font-semibold text-orange-800 mb-6">About</h1>
                </div>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        >
          <div className="w-32 h-32 rounded-full mb-4 bg-orange-500 flex items-center justify-center text-white text-5xl font-bold">
